...
base_command_template = (
    ...
    "--loss-coefficient 1.0 --complex-rate {complex_rate} "
...
substrings_num_values = [10,15]  # 从 1 到 7
complex_rate_values = [0.0]

# 遍历所有参数组合
for dname,substrings_num, complex_rate in itertools.product(
    dname_values,substrings_num_values, complex_rate_values
):
    # 根据模板填充参数，保证选项顺序
